...
interface IngredientRepository {
    ...
    suspend fun createIngredient(ingredient: Ingredient, userId: String): Result<Unit>
    suspend fun updateIngredient(ingredient: Ingredient, userId: String): Result<Unit>
    suspend fun deleteIngredient(id: String, userId: String): Result<Unit>
}
